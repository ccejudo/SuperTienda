...
if (isset($_SESSION['loggedin']) && $_SESSION['loggedin'] == true) {
		...
		echo "</tr>";
			...
			while ($lollol = mysqli_fetch_assoc($users)) {
				 ...
				 echo "<input type='hidden' name='user' value='".$realuser."'>";
				 echo "<tr>";
				 echo "<td>".$realuser."</td>";
				 ...
				 if ($realuser != $user) {
					echo "<td><button name=removeUser type='submit' class='pull-xs-right'>Remover</button></td>";
				 }
				 echo "</tr>";
				 echo "</form>";
			 }
			...
			while ($lellel = mysqli_fetch_assoc($prods)) {
				 echo "<form action='index-color.php' method='post'>";
				 echo "<input type='hidden' name='product' value='".$lellel['pro_id']."'>";
				 echo "<tr>";
				 ...
				 echo "<td><button name='removeProduct' type='submit' class='pull-xs-right'>Remover</button></td>";
				 echo "</tr>";
				 echo "</form>";
			 }
